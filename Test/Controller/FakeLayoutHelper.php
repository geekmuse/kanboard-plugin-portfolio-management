 ...
 *
 * Intercepts $this->helper->layout->app() and ->config() calls,
 * recording the template/params and rendering the template file
 * from the plugin's Template/ directory.
 *
 * Exposes $text, $url, $form so templates rendered via include
 * can call $this->text->e(), $this->url->href(), $this->form->csrf().
 */
