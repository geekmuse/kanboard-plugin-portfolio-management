...
<form method="post" action="<?= $this->url->href('PortfolioModificationController', 'save', [], 'Portfolio') ?>" class="portfolio-form">
    <?= $this->form->csrf() ?>
    <?php require __DIR__ . '/_form.php' ?>

    <div class="portfolio-form-actions">
        <button type="submit" class="btn btn-blue"><?= $this->text->e(t('Save')) ?></button>
        <a href="<?= $this->url->href('PortfolioListController', 'index', [], 'Portfolio') ?>" class="btn">
